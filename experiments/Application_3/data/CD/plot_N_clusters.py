...
df_E = pd.read_csv('N_clusters_k=30_E.csv', index_col=0, header=0)
df_E.columns = ['Number of clusters']
df_E['Method'] = 'Euclidean'
df_dmlmj_cv = pd.read_csv('N_clusters_k=30_CV.csv', index_col=0, header=0)
...
df_dmlmj_v = pd.DataFrame(pd.read_csv('V_k=30_CV.csv', index_col=0, header=0).values.reshape(-1,1))
